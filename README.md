...
1. **ProPresenter** (7.9+ / 8): Настройки → Сеть → включить **Network** (API).
...
**Проверка после изменений**: `node test/smoke.js` (11 проверок: статика, прокси,
переключения, миниатюры, затемнение, библиотеки, плейлисты).
